...
namespace ROSBridgeLib {
	namespace sensor_msgs {
		public class ImuMessage : ROSBridgeMsg {
			...
			public ImuMessage(HeaderMsg header,
												QuaternionMsg quaternionIMU,
												double[] orientation_c,
												Vector3Msg angularVelocity,
												double[] angular_velocity_c,
												Vector3Msg linearAcceleration,
												double[] linear_acceleration_c) {
				_header = header;
			...
			*/
			...
			// NOTE(milo): This is called by ROSBridgeWebSocketConnection --> Publish.
			public override string ToYAMLString() {
				return "{\"header\" : " + _header.ToYAMLString() + ", \"orientation\" : " + _quaternionIMU.ToYAMLString() + ", \"orientation_covariance\" : " + FormatUtils.ArrayToString<double>(ref _orientation_c) + ", \"angular_velocity\" : " + _angularVelocity.ToYAMLString() + ", \"angular_velocity_covariance\" : " + FormatUtils.ArrayToString<double>(ref _angular_velocity_c) + " , \"linear_acceleration\" : " + _linearAcceleration.ToYAMLString() +" , \"linear_acceleration_covariance\" : " + FormatUtils.ArrayToString<double>(ref _linear_acceleration_c) + "}";
			}
			/*
			public override string ToString() {

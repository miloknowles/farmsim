...
public class TestTransformUtil
{
  ...
  public void TestToRightHandedTranslation()
  {
    ...
    Vector3 t_rh_0 = TransformUtils.ToRightHandedTranslation(t_lh_0);
    Assert.AreEqual(t_rh_0, new Vector3(1, -2, 3));

    Vector3 t_lh_1 = new Vector3(1, -2, 3);
    Vector3 t_rh_1 = TransformUtils.ToRightHandedTranslation(t_lh_1);
  ...
  public void TestToRightHandedQuaternion()
  {
    ...
    Quaternion q_identity_rh = TransformUtils.ToRightHandedQuaternion(q_identity_lh);
    ...
    Quaternion q_lookup_rh = TransformUtils.ToRightHandedQuaternion(q_lookup_lh);
    ...
    Quaternion q_lookdown_rh = TransformUtils.ToRightHandedQuaternion(q_lookdown_lh);
    ...
    Quaternion q_lookleft_rh = TransformUtils.ToRightHandedQuaternion(q_lookleft_lh);
    ...
    Quaternion q_lookr_rh = TransformUtils.ToRightHandedQuaternion(q_lookr_lh);
    ...
    Quaternion q_lookb_rh = TransformUtils.ToRightHandedQuaternion(q_lookb_lh);
  ...
  {
    Assert.AreEqual(new Vector3(-1, 2, -3), TransformUtils.ToRightHandedAngularVelocity(new Vector3(1, 2, 3)));
  }
}
